...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.
                ...
                .antMatchers("/books/listbooks").permitAll()
                .antMatchers("/books/savebook").permitAll()
                .antMatchers("/books/deltebooks/*").permitAll()
                .antMatchers("/clients").permitAll()
                .antMatchers("/client/add").permitAll()
                .antMatchers("/delete_client/*").permitAll()
                .antMatchers("/disable_client/*").permitAll()
                .antMatchers("/enable_client/*").permitAll()
