package com.sebasira.MediumTutorialSecurity;
...
public class MediumTutorialSecurityApplication {

	public static void main(String[] args) {
		SpringApplication.run(MediumTutorialSecurityApplication.class, args);
	}
